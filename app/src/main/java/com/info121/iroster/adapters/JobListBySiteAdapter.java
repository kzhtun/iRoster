...
public class JobListBySiteAdapter extends RecyclerView.Adapter<JobListBySiteAdapter.ViewHolder> {
    ...
    public JobListBySiteAdapter(Context mContext, List<JobDetail> mListJob, String mStatus) {
    ...
    public JobListBySiteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        if (mStatus.equalsIgnoreCase("CFM"))
            searchView = inflater.inflate(R.layout.cell_job_item_by_site_cfm, parent, false);
        else
            searchView = inflater.inflate(R.layout.cell_job_item_by_site_pnd, parent, false);
...
//        viewHolder.shiftDesc.setText(mListJob.get(i).getShiftDesc());
   ...
   //     viewHolder.status.setText(mListJob.get(i).getStatus());
        ...
        if (mListJob.get(i).getStatus().toString().equalsIgnoreCase("CFM") || mListJob.get(i).getStatus().toString().equalsIgnoreCase("CONFIRMED")) {

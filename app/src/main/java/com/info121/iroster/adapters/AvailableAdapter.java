...
public class AvailableAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AvailableAdapter(Context mContext, List<JobDetail> mListJob, JobDetail mJobDetail) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int i) {
        ...
        if (holder instanceof HeaderViewHolder) {
            ...
            if(mJobDetail != null) {
                ...
                viewHolder.mainLayout.setVisibility(GONE);
...
//                notifyDataSetChanged();
    ...
    public int getItemViewType(int position) {
        ...
        if(position==0)
            return TYPE_HEADER;
        else if(position == mListJob.size()-1)
            return TYPE_REMARK;
        else
            return TYPE_ITEM;
    }
